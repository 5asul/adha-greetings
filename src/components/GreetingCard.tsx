...
export const GreetingCard = ({ userName, senderName, onBack }: GreetingCardProps) => {
  ...
  const receivedGreetingMessage = encodeURIComponent(
    `🌙 عيد أضحى مبارك! 🌙
...
#عيد_الأضحى_مبارك`
  ...
  const personalGiftMessage = encodeURIComponent(
      ...
      <div className="w-full max-w-sm sm:max-w-md mx-auto space-y-4">
          ...
          <div className="p-4 text-center space-y-4">
            ...
            <div className="bg-gradient-to-r from-islamic-gold/10 via-islamic-cream/40 to-islamic-gold/10 p-4 rounded-xl border-2 border-islamic-gold/30 shadow-inner">
              <div className="text-center">
                ...
                <p className="text-islamic-olive-light arabic text-xs italic">
                  دعاء مبارك
                </p>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              onClick={shareReceivedGreeting}
              className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white py-3 rounded-2xl flex items-center justify-center gap-2 arabic font-bold shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
            >
            ...
            <Button
              onClick={shareOnX}
              className="bg-gradient-to-r from-black to-gray-800 hover:from-gray-800 hover:to-black text-white py-3 rounded-2xl flex items-center justify-center gap-2 arabic font-bold shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
